...
public class MainApplication {
    ...
    public static void main(String[] args) {
        ...
        String maxSizeProp = env.getProperty("max.size");

        System.out.println("maxSizeProp = " + maxSizeProp);
