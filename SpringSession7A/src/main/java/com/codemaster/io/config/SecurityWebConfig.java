...
import com.codemaster.io.provider.CustomOAuthProvider;
...
public class SecurityWebConfig {
    ...
    @Autowired
    private CustomOAuthProvider customOAuthProvider;

    @Bean
    public AuthenticationManager authenticationManager() throws Exception {
        return new ProviderManager(Arrays.asList(customOAuthProvider, customAuthenticationProvider));
    }
